...
from main.model.LSTM_weekly2weekly_architecture import build_lstm_v2_architecture, build_lstm_feed_architecture, \
    build_cnn_lstm_v2_architecture, build_cnn_lstm_v2_luong_architecture, build_cnn_bi_lstm_v2_luong_architecture
...
def build_cnn_bi_lstm_v2_luong_model(train, train_label, n_input, lstm_units, decoder_dense_units, conv1d_filters,
                                     optimizer, epochs=35, n_out=6, n_gap=7, day_increment=7,
                                     batch_size=16, verbose=0, statistical_operation: Dict = None):
    # prepare data
    _, train_x_weekly, _, _, train_y_weekly = time_series_data_preparation(train, train_label, n_input,
    ...
    # define model
    model = build_cnn_bi_lstm_v2_luong_architecture(lstm_units, decoder_dense_units, conv1d_filters,
                                                     n_timesteps, n_features, n_outputs)

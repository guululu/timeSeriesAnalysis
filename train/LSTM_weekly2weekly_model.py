...
def build_lstm_feed_model(train: 'np.ndarray', train_label: 'np.ndarray', n_input: int, lstm_units: int,
                          decoder_dense_units: int, optimizer: Optimizer, epochs: int, n_out: int, n_gap: int,
                          day_increment: int, batch_size: int, verbose: int, statistical_operation: Dict) -> Model:
    """
    Args:
...
def build_cnn_lstm_v2_luong_model(train: 'np.ndarray', train_label: 'np.ndarray', n_input: int, lstm_units: int,
                                  decoder_dense_units: int, conv1d_filters, optimizer: Optimizer, epochs: int,
                                  n_out: int, n_gap: int, day_increment: int, batch_size: int, verbose: int,
                                  statistical_operation: Dict) -> Model:
    """
    Args:
        train: model training input features
...
def build_conv2d_lstm_v2_model(train: 'np.ndarray', train_label: 'np.ndarray', n_input: int, filters: int,
                               decoder_dense_units: int, optimizer: Optimizer, epochs: int, n_out: int,
                               n_gap: int, day_increment: int, batch_size: int, verbose: int,
                               statistical_operation: Dict) -> Model:
    """
   Args:
